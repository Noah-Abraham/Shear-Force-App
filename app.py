...
({vx:} kN, {vy:.1f} kN)", fontsize=7, color='black', ha='right', va='top')
...
({vx:} kN, {vz:.1f} kN)", fontsize=7, color='black', ha='right', va='top')
...
({vy:} kN, {vz:.1f} kN)", fontsize=7, color='black', ha='right', va='top')
