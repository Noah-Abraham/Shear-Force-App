...
if bolts:
    ...
    for i, (x, y, vx, vy, vz) in enumerate(shear_forces):
        if view_option == "XY View":
            ...
            ax.quiver(x, 0, x, vz * vector_display_scale, angles='90', scale_units='xy', scale=1, color='green')
            ax.plot(x, 0, 'ro')
            ...
            ax.quiver(y, 0, y, vz * vector_display_scale, angles='90', scale_units='xy', scale=1, color='purple')
            ax.plot(y, 0, 'ro')
